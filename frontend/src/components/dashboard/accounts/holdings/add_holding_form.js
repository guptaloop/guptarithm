...
export default class AddHoldingForm extends Component {
		...
		this.props.createHolding(holding)
			.then(() => {
				if (this.props.errors.length === 0) {
					this.props.fetchPrices(holding.symbol);
	...
	render() {
		...
		switch (this.state.formState) {
			...
			case 2:
				holdingOrAssetForm = (
					<div className="asset-search-dne">
						<h1>This security does not exist in our database :(</h1>
...
// code for Users to be able to add a security to the Assets table
